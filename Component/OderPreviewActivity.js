...
class OderPreviewActivity extends Component {

    constructor(props) {
        super(props);
        this.state = {
            data: [
                {ItemName: 'Item Name:',image:"https://images.unsplash.com/photo-1498837167922-ddd27525d352?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",Description :"Description ",Price :'100/-'},
                {ItemName: 'Item Name:',image:"https://images.unsplash.com/photo-1498837167922-ddd27525d352?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",Description :"Description ",Price :'100/-'},
                {ItemName: 'Item Name:',image:"https://images.unsplash.com/photo-1498837167922-ddd27525d352?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",Description :"Description ",Price :'100/-'},
                {ItemName: 'Item Name:',image:"https://images.unsplash.com/photo-1498837167922-ddd27525d352?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",Description :"Description ",Price :'100/-'},
                {ItemName: 'Item Name:',image:"https://images.unsplash.com/photo-1498837167922-ddd27525d352?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",Description :"Description ",Price :'100/-'},
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.headerView}>
                  ...
                  <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center' }} >
                        ...
                        <Text style={styles.screentitle}>Oder Preview</Text>
...
{/* 
                    ...
                    <TouchableOpacity  >
                      ...
                      <Text style={styles.ServiceTitle}>Bill </Text>
                    ...
                    <View style={styles.box}>
                            ...
                            <View style={styles.box}>
                                <Text  style={styles.name}>Item 2:</Text>
                                <View style={styles.infobill}>
                            ...
                            <View style={styles.box}>
                                ...
                                <Text  style={styles.name}>200</Text>
                            ...
                            <TouchableOpacity
                                    ...
                                    activeOpacity={.20}
                                    onPress={() => { this.props.navigation.navigate('OderDetailsActivity') }}>
                                    <Text style={styles.buttonWhiteTextStyle}>Pay Now</Text>
...
export default OderPreviewActivity;