...
class ServiceActivity extends Component {
  constructor (props) {
    super(props)
    this.state = {
      data: [
        ...
        <View style={styles.headerView}>
          ...
          <View style={styles.container4}>
            <TouchableOpacity
              ...
              <Text style={styles.screentitle}>Service</Text>
            </TouchableOpacity>
          </View>
            ...
            <FlatList
              ...
              renderItem={({item}) => {
                return (
                  <TouchableOpacity
                    onPress={() => {
                      this.props.navigation.navigate('ElecticianActivity',{"titleName": item.service})
                     // console.log("sdfg",titleName)
                    }}>
