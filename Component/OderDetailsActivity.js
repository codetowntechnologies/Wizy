...
class OderDetailsActivity extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            data: [
                {key: 'You Have a ride arriving',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Food is arriving',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Have Booked Electrician',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Have a ride arriving',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Food is arriving',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Have Book Electrician',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Food is arriving',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Have Book Electrician',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Have a ride arriving',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
                {key: 'You Food is arriving',image:"https://bootdey.com/img/Content/avatar/avatar1.png"},
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.container} >
                    ...
                    <TouchableOpacity  >
                      ...
                      <Text style={styles.ServiceTitle}>Bill Information</Text>
